...
export default function Header() {
    ...
    return (
        <header className={cn("fixed z-50 w-full transition-all duration-300", scrolled ? "top-0 bg-white/80 backdrop-blur-md shadow-sm py-2 border-b border-white/20 supports-[backdrop-filter]:bg-white/60 text-foreground" : "top-[72px] sm:top-10 bg-transparent py-3 sm:py-4 text-white")}>
