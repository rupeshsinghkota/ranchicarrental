...
export default function Home() {
  ...
  // Countdown timer end time (midnight today)
  const offerEndTime = new Date();
  offerEndTime.setHours(24, 0, 0, 0);
        ...
        <div className="container-custom relative z-10 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="animate-in slide-in-from-left-4 duration-700 text-center lg:text-left pt-8 lg:pt-0">
            ...
            <div className="mt-8 flex flex-col gap-4 items-center lg:items-start">
              <div className="flex flex-wrap justify-center lg:justify-start gap-4 lg:gap-6 text-sm text-slate-300">
              ...
              <LiveStats />
              <CountdownTimer endTime={offerEndTime} message="10% OFF ends in" />
            </div>
          </div>
              ...
              <div key={i} className="bg-slate-800 rounded-xl overflow-hidden hover:transform hover:-translate-y-1 transition-all duration-300 relative group">
                ...
                <div className="p-6 text-left">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <AvailabilityBadge available={i === 0 ? 2 : i === 1 ? 1 : 4} />
                  </div>
