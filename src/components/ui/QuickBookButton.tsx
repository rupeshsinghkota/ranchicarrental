...
export default function QuickBookButton({ carName, carPrice, className = "" }: QuickBookButtonProps) {
    const handleQuickBook = () => {
        ...
        gaEvents.whatsappClick(carName, 'quick_book_button');
    ...
    return (
        <button
            ...
            className={`flex items-center justify-center gap-2 bg-[#25D366] text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-[#128C7E] transition-all hover:scale-105 shadow-md hover:shadow-lg ${className}`}
        >
