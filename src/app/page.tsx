...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      />
      {/* Hero Section */}
      <section className="relative bg-slate-900 text-white py-12 lg:py-24 overflow-hidden">
        ...
        <div className="container-custom relative z-10 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="animate-in slide-in-from-left-4 duration-700 text-center lg:text-left pt-8 lg:pt-0">
            ...
            <p className="text-lg lg:text-xl text-slate-300 mb-8 lg:mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="mt-8 flex flex-wrap justify-center lg:justify-start gap-4 lg:gap-6 text-sm text-slate-300">
              ...
              <div className="flex items-center gap-2 bg-slate-800/50 px-3 py-1 rounded-full backdrop-blur-sm"><CheckCircle className="text-green-500" size={16} /> 24/7 Support</div>
              <div className="flex items-center gap-2 bg-slate-800/50 px-3 py-1 rounded-full backdrop-blur-sm"><CheckCircle className="text-green-500" size={16} /> Unlimited KMs Options</div>
            </div>
          </div>
        ...
        <div className="container-custom text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {featuredCars.map((car, i) => (
              <div key={i} className="bg-slate-800 rounded-xl overflow-hidden hover:transform hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="p-6 text-left">
                  ...
                  <p className="text-secondary font-bold text-lg mb-4">{car?.price} <span className="text-sm font-normal text-slate-400">/ 24 hrs</span></p>
                  ...
                  <Link href="/book" className={getButtonClass('primary', 'default', "w-full bg-white text-slate-900 hover:bg-slate-200")}>
                    Book This Car
                  </Link>
                </div>
              </div>
      ...
      <section className="py-20 bg-primary">
        <div className="container-custom text-center text-white">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Call us now or book online to get the best self-drive car deals in Ranchi.</p>
